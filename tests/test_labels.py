...
def test_generate_labels_adds_temporal_protocol_columns_and_passes_leakage_checks():
    size = 80
    frame = pd.DataFrame(
        {
            "timestamp": pd.date_range("2024-01-01", periods=size, freq="min", tz="UTC"),
            "us100_high": [101.0] * size, "us100_low": [99.0] * size, "us100_close": [100.0] * size,
            "us100_atr_15": [1.0] * size, "us100_slope_15": [0.3] * size, "us100_momentum_10": [0.2] * size,
            "us100_momentum_5": [0.1] * size, "us100_momentum_3": [0.1] * size, "us100_distance_high_20": [0.0] * size,
            "us100_volume_z_15": [1.0] * size, "us100_lower_wick": [0.01] * size, "us100_upper_wick": [0.01] * size,
            "us100_range": [0.02] * size, "us100_compression_20": [0.5] * size, "us100_outside_bar": [0.0] * size, "us100_body": [0.001] * size,
            "us500_high": [101.0] * size, "us500_low": [99.0] * size, "us500_close": [100.0] * size,
            "us500_atr_15": [1.0] * size, "us500_slope_15": [0.3] * size, "us500_momentum_10": [0.2] * size,
            "us500_momentum_5": [0.1] * size, "us500_momentum_3": [0.1] * size, "us500_distance_high_20": [0.0] * size,
            "us500_volume_z_15": [1.0] * size, "us500_lower_wick": [0.01] * size, "us500_upper_wick": [0.01] * size,
            "us500_range": [0.02] * size, "us500_compression_20": [0.5] * size, "us500_outside_bar": [0.0] * size, "us500_body": [0.001] * size,
            "trend_agreement": [1.0] * size, "spread_return_diff": [0.0] * size, "spread_z_20": [0.0] * size,
            "divergent_regime": [0.0] * size, "joint_volatility": [0.1] * size, "is_session_open_window": [1.0] * size,
        }
    )
    labeled = generate_labels(frame, LabelConfig(), ["trend_continuation"])
    assert "us100_trend_continuation_trigger_timestamp" in labeled.columns
