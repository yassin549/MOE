...
def test_heuristic_baseline_marks_not_enough_data_when_under_threshold():
    config = AppConfig()
    config.labels.expectancy_min_trades = 3
        ...
        [
            {
                ...
                "expectancy_ci_lower_r": 0.3,
                "expectancy_ci_upper_r": 0.5,
                "expectancy_min_trades": 3,
        ...
        [
            {
                ...
                "expectancy_ci_lower_r": -0.01,
                "expectancy_ci_upper_r": 0.41,
                "expectancy_min_trades": 3,
